...
`vol_history` is purpose-built for backtests: a clean daily series at a fixed maturity and fixed strike. Available on every plan — full archive, no history-window restriction.
